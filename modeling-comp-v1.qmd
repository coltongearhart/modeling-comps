...
# hard coded formula
"sale_price ~ lot_frontage + lot_area + year_built + year_remod_add + 
    ...
    wood_deck_sf + screen_porch + pool_area + misc_val + latitude"
...
mod_final_prime <- lm(formula_final_prime, data = ames_train)
